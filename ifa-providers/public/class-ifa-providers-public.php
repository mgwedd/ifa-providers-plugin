 ...
 * @subpackage IFA_Providers/public
 */
...
class IFA_Providers_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $ifa_providers       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->ifa_providers, plugin_dir_url( __FILE__ ) . 'css/ifa-providers-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->ifa_providers, plugin_dir_url( __FILE__ ) . 'js/ifa_providers-public.js', array( 'jquery' ), $this->version, false );
